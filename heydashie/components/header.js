/**
 * Header/navigation for heydashie.com — "Dashie" (the paid family product).
 ...
 *
 * This is the paid side of the brand split, so pricing and the purchase CTA
 * belong here. Outbound links to dashieapp.com (guides, legal) are fine — the
 * audience boundary is one-directional: dashieapp.com must never link *here*.
 * The HA-facing counterpart lives at the repo root: components/header.js.
 */
...
<nav class="nav-bar">
  <div class="nav-bar-left">
    ...
    <ul>
      <li><a href="/" class="${getActiveClass('/')}">For Families</a></li>
      ...
      <li class="nav-dropdown">
        ...
        <div class="nav-dropdown-menu">
          <a href="https://dashieapp.com/privacy-policy.html">Privacy Policy</a>
          <a href="https://dashieapp.com/terms-of-service.html">Terms of Service</a>
          <a href="https://dashieapp.com/contact">Contact Us</a>
        </div>
      </li>
    </ul>
  </div>
...
<div class="mobile-menu" id="mobile-menu">
  ...
  <ul>
    ...
    <li><a href="https://dashieapp.com/privacy-policy.html" class="mobile-sub-item">Privacy Policy</a></li>
    <li><a href="https://dashieapp.com/terms-of-service.html" class="mobile-sub-item">Terms of Service</a></li>
    <li><a href="https://dashieapp.com/contact" class="mobile-sub-item">Contact Us</a></li>
  </ul>
